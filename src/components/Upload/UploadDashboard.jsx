...
import { useNotifications } from "../../context/NotificationContext";  // ✅ IMPORTANT
...
const UploadDashboard = () => {
    ...
    const { addNotification } = useNotifications();  // ✅ IMPORTANT
    ...
    const submit = async () => {
        ...
        try {
            ...
            addNotification("success", "All files uploaded successfully"); // ✅ works now
            setFiles([]);
        } catch (err) {
            toast.error(
                <span>
            ...
            addNotification("error", "Upload failed"); // ✅ works now
        } finally {
            setLoading(false);
        }
    };
